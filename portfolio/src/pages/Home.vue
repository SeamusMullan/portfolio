      ...
      <div class="relative max-w-6xl mx-auto px-4 py-24 md:py-32 text-center">
        ...
        <div class="flex flex-wrap gap-6 justify-center">
          <Button asChild variant="secondary" size="lg" class="text-lg px-8 py-4 shadow-xl">
            <router-link to="/experience" class="text-black dark:text-white">Work Experience</router-link>
          </Button>
          
          <Button asChild variant="secondary" size="lg" class="text-lg px-8 py-4 shadow-xl">
            <router-link to="/projects" class="text-black dark:text-white">My Projects</router-link>
          </Button>
      ...
      <CardContent>
        ...
        <div class="flex flex-wrap gap-4 justify-center">
          ...
          <Button asChild variant="outline" size="lg" class="text-lg px-8 py-3 border-white text-white hover:bg-white hover:text-emerald-700">
            <a href="https://github.com/seamusmullan" target="_blank" rel="noopener" class="!text-black dark:!text-white flex items-center gap-2">View GitHub
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                <path d="M10 5H8.2C7.08 5 6.52 5 6.09 5.22C5.72 5.41 5.41 5.72 5.22 6.09C5 6.52 5 7.08 5 8.2V15.8C5 16.92 5 17.48 5.22 17.91C5.41 18.28 5.72 18.59 6.09 18.78C6.52 19 7.08 19 8.2 19H15.8C16.92 19 17.48 19 17.91 18.78C18.28 18.59 18.59 18.28 18.78 17.91C19 17.48 19 16.92 19 15.8V14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M20 9V4M20 4H15M20 4L13 11" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </a>
          </Button>
        </div>
